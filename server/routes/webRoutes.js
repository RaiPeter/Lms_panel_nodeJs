...
function progress_middleware(req, res, next) {
    ...
    req.on("data", (chunk) => {
        ...
        const percentage = Math.floor((progress / file_size) * 100);
        // other code ...
...
router.post('/add-class', progress_middleware, uploadClass.single('class_video'), webController.add_classPost);
